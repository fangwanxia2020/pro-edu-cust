...
var IS_SAFARI_OR_UIWEBVIEW =
  navigator && /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent)
...
function getSourceCanvas(image, _ref6, _ref7, _ref8) {
  ...
  var rotate = _ref6.rotate
  var scaleX = _ref6.scaleX
  var scaleY = _ref6.scaleY
...
var handlers = {
  resize: function resize() {
    ...
    if (ratio !== 1 || container.offsetHeight !== containerData.height) {
      ...
      if (options.restore) {
        this.setCanvasData(
          each(canvasData, function (n, i) {
            canvasData[i] = n * ratio
          })
        )
        this.setCropBoxData(
          each(cropBoxData, function (n, i) {
...
var methods = {
  ...
  move: function move(offsetX, offsetY) {
    ...
    var left = _canvasData.left
    var top = _canvasData.top
