      ...
      <div class="app-main-wrap">
        <div class="app-main-ctn">
          <keep-alive :include="cachedViews">
            <router-view :key="key" v-show="!$route.meta.isMicrApp" />
          </keep-alive>
          <div id="subapp-viewport" v-show="$route.meta.isMicrApp">
            <div v-if="$root.$children[0].isLoading" class="loadEffect">
              <span></span>
              <span></span>
              <span></span>
              <span></span>
...
export default {
  ...
  created() {
    ...
    // console.log(this.$root.$children[0].isLoading, "---- {{this.$root}}");
  }
}
</script>
