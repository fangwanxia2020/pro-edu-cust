    ...
    children: [
      {
        ...
        component: () => import('@/views/system/information/infoManage/createNews'),
        name: 'InfoManageAdd',
        meta: {
          title: '新建消息',
      ...
      },
      {
        ...
        component: () => import('@/views/system/information/infoManage/newsContent'),
    ...
    children: [
      {
        ...
        component: () => import('@/views/system/information/myInformation/informationContent'),
        meta: {
          title: '信息详情',
      ...
      },
      {
        ...
        component: () => import('@/views/system/information/myInformation/receiveSettings'),
        meta: {
          title: '接收设置',
          activeMenu: '/information/myInformation'
        }
