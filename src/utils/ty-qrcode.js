...
if (!(r + e <= -1 || u <= r + e)) {
for (var n = -1; n <= 7; n += 1) {
t + n <= -1 || u <= t + n || (e >= 0 && e <= 6 && (n == 0 || n == 6) || n >= 0 && n <= 6 && (e == 0 || e == 6) || e >= 2 && e <= 4 && n >= 2 && n <= 4 ? i[r + e][t + n] = !0 : i[r + e][t + n] = !1);
}
}
}
      },
...
for (var u = -2; u <= 2; u += 1) {
for (var f = -2; f <= 2; f += 1) {
u == -2 || u == 2 || f == -2 || f == 2 || u == 0 && f == 0 ? i[n + u][a + f] = !0 : i[n + u][a + f] = !1;
}
}
}
          }
      ...
      y = function (r,t) {
          for (var e = a << 3 | t,
              n = QRUtil.getBCHTypeInfo(e),o = 0; o < 15; o += 1) {
              var f = !r && (n >> o & 1) == 1;
      ...
      M = function (r,t) {
          for (var e = -1,
              ...
              o = 7,
              a = 0,
              f = QRUtil.getMaskFunction(t),c = u - 1; c > 0; c -= 2) {
for (c == 6 && (c -= 1); ;) {
                  for (var g = 0; g < 2; g += 1) {
if (i[n][c - g] == null) {
                      var l = !1;

                      a < r.length && (l = (r[a] >>> o & 1) == 1);
                      var h = f(n,c - g);
      ...
      B = function (r,t) {
          for (var e = 0,
              n = 0,
              o = 0,
              a = new Array(t.length),i = new Array(t.length),u = 0; u < t.length; u += 1) {
              var f = t[u].dataCount,
                  c = t[u].totalCount - f;
...
g < i[u].length && (w[y] = i[u][g],y += 1);
      ...
      p = function (r,t,o) {
          for (var a = QRRSBlock.getRSBlocks(r,t),i = qrBitBuffer(),u = 0; u < o.length; u += 1) {
              ...
              i.put(f.getMode(),4),
                  i.put(f.getLength(),QRUtil.getLengthInBits(f.getMode(),r)),
                  f.write(i);
          }
          for (var c = 0,
              u = 0; u < a.length; u += 1) {
...
break;
              ...
              if (i.put(e,8),i.getLengthInBits() >= 8 * c) {
break;
}
              i.put(n,8);
          }
...
throw new Error(r + ',' + t);
      ...
      g.createTableTag = function (r,t) {
          r = r || 2,
              t = typeof t == 'undefined' ? 4 * r : t;
          var e = '';

          e += '<table style="',
              e += ' border-width: 0upx; border-style: none;',
              e += ' border-collapse: collapse;',
              e += ' padding: 0upx; margin: ' + t + 'upx;',
              e += '">',
              e += '<tbody>';
...
t.push(a);
                  ...
                  typeof i == 'number' ? (255 & i) == i ? t.push(i) : (t.push(i >>> 8),t.push(255 & i)) : t.push(n);
              }
          }
          return t;
      };
...
for (var o = 0; o < t; o += 1) {
                  for (var a = 0,
                      i = r.isDark(n,o),u = -1; u <= 1; u += 1) {
if (!(n + u < 0 || t <= n + u)) {
for (var f = -1; f <= 1; f += 1) {
o + f < 0 || t <= o + f || u == 0 && f == 0 || i == r.isDark(n + u,o + f) && (a += 1);
}
}
}
                  a > 5 && (e += 3 + a - 5);
...
throw new Error('bad rs block [url=home.php?mod=space&uid=5302]@[/url] typeNumber:' + r + '/errorCorrectLevel:' + e);
}
  ...
  qrBitBuffer = function () {
      ...
      return e.getBuffer = function () {
          ...
          e.getAt = function (t) {
              ...
              return (r[e] >>> 7 - t % 8 & 1) == 1;
          },
          e.put = function (r,t) {
              for (var n = 0; n < t; n += 1) {
e.putBit((r >>> t - n - 1 & 1) == 1);
}
          },
  ...
  qr8BitByte = function (r) {
      for (var t = QRMode.MODE_8BIT_BYTE,
          e = r,
          n = [],o = {},
          ...
          f > 65536 ? (u[0] = 240 | (1835008 & f) >>> 18,u[1] = 128 | (258048 & f) >>> 12,u[2] = 128 | (4032 & f) >>> 6,u[3] = 128 | 63 & f) : f > 2048 ? (u[0] = 224 | (61440 & f) >>> 12,u[1] = 128 | (4032 & f) >>> 6,u[2] = 128 | 63 & f) : f > 128 ? (u[0] = 192 | (1984 & f) >>> 6,u[1] = 128 | 63 & f) : u[0] = f,
              n.push(u);
      }
      n = Array.prototype.concat.apply([],n),
          n.length != e.length && (n.unshift(191),n.unshift(187),n.unshift(239));
      var c = n;
...
a.add(String.fromCharCode(u));
              ...
              for (l += 1; l < o.length;) {
                  ...
                  l += 1,
                      a.contains(h + v) ? h += v : (g.write(a.indexOf(h),n),a.size() < 4095 && (a.size() == 1 << n && (n += 1),a.add(h + v)),h = v);
              }
              return g.write(a.indexOf(h),n),
                  g.write(e,n),
                  g.flush(),
                  c.toByteArray();
          },
