/* eslint-disable no-await-in-loop */ /* eslint-disable no-await-in-loop */ /* eslint-disable
no-await-in-loop */
<!-- 企业基本信息 -->
<template>
    ...
    <div class="design-form-wrap__ctnwrap">
      <div class="step-wrap">
        <div class="step-wrap-box">
          ...
          >
            <!-- 基本信息 -->
            <div class="design-form" slot="basicInfo">
              <pc-form
              ...
              >
                ...
                <!-- 所在乡镇（街道） -->
                <el-select slot="street" v-model="editData.editEnterpriseDto.street">
                  <el-option
            ...
            <!-- 联系信息 -->
            <div class="design-form" slot="contractInfo">
              <pc-form
            ...
            <!-- 所在行业信息 -->
            <div class="design-form" slot="industryInfo">
              <pc-form
            ...
            <!-- 人员信息 -->
            <div class="design-form" slot="personInfo">
              <pc-form
            ...
            <!-- 其他信息 -->
            <div class="design-form" slot="otherInfo">
              <pc-form
            ...
            <el-button slot="operation" type="primary" @click="handleSave">保存</el-button>
          </ty-steps>
        </div>
      </div>
    </div>
...
import { basicInfo, contractInfo, industryInfo, personInfo, otherInfo } from './jsonData'
...
export default {
  ...
  watch: {
    uploadFiles: {
      ...
      // 格式化上传附件 id
      handler(files) {
        const { editEnterpriseDto } = this.editData
  ...
  methods: {
    async renderEditData() {
      ...
      const { editEnterpriseDto } = data
      const { editEnterpriseDetailDto } = data // 企业详细信息(与基础信息合并在一起)
      this.editData = {
        ...data,
        editEnterpriseDto: {
          ...editEnterpriseDto,
    ...
    async handleSave() {
      ...
      const { saftStandardizationBegin } = req.editEnterpriseOtherDto
      const { saftStandardizationEnd } = req.editEnterpriseOtherDto
      req.editEnterpriseOtherDto.saftStandardizationBegin =
        this.formatDateTime(saftStandardizationBegin)
      req.editEnterpriseOtherDto.saftStandardizationEnd =
        this.formatDateTime(saftStandardizationEnd)
