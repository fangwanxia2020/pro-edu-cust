<template>
  <div class="add-person-basic-info design-form-wrap">
    <div class="design-form-wrap__ctnwrap">
      <el-tabs v-model="activeName" class="autoheight-tab">
        <el-tab-pane label="基本信息" name="0">
          <div class="design-form">
            <pc-form :data="basicInfo" v-model="editData" ref="basicInfoForm" />
          </div>
        </el-tab-pane>
        <el-tab-pane v-if="isViewState" label="证书持有情况" name="1">
          <div class="design-form">
            <ty-table
        ...
        <el-tab-pane v-if="isViewState" label="培训情况" name="2">
          <div class="design-form">
            <ty-business-crud
    ...
    <div class="design-form-wrap__btnwrap">
      <el-button v-if="!isViewState" type="primary" size="small" @click="handleSave"
        >保存</el-button
      >
      <el-button size="small" @click="navigater('/basicData/personBasicInfo')">取消</el-button>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    async init() {
      const { enterprisePersonId, deptId } = this.$route.query
