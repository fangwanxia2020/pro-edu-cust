import { regMap } from '@/utils/validate.js'
          ...
          list: [
            {
              ...
              options: {
                ...
                filterable: false,
                optionDataType: 2,
                interfaceMethod: '/basic/system/dict/data/dictType/sys_user_sex',
                interfaceParam: {},
          ...
          list: [
            {
              ...
              options: {
                ...
                filterable: false,
                optionDataType: 2,
                interfaceMethod: '/basic/system/dict/data/dictType/hse_IDType',
                interfaceParam: {},
          ...
          list: [
            {
              ...
              options: {
                ...
                filterable: false,
                optionDataType: 2,
                interfaceMethod: '/basic/system/dict/data/dictType/hse_diploma',
                interfaceParam: {},
          ...
          list: [
            {
              ...
              options: {
                ...
                filterable: false,
                optionDataType: 2,
                interfaceMethod: '/basic/system/dict/data/dictType/hse_party',
                interfaceParam: {},
          ...
          list: [
            {
              ...
              options: {
                ...
                filterable: false,
                optionDataType: 2,
                interfaceMethod: '/basic/system/dict/data/dictType/hse_health',
                interfaceParam: {},
                interfaceId: '',
                resList: 'data',
                interfaceType: 'get',
          ...
          list: [
            {
              ...
              options: {
                ...
                filterable: false,
                optionDataType: 2,
                interfaceMethod: '/basic/system/dict/data/dictType/hse_personType',
                interfaceParam: {},
                interfaceId: '',
                resList: 'data',
                interfaceType: 'get',
              ...
              rules: [
                {
                  validator(rule, value, cb) {
                    if (value && !regMap.telephone.test(value)) {
          ...
          list: [
            {
              ...
              rules: [
                {
                  validator(rule, value, cb) {
                    if (value && !regMap.regPhone(value)) {
          ...
          list: [
            {
              ...
              rules: [
                {
                  validator(rule, value, cb) {
                    if (value && !regMap.email.test(value)) {
              ...
              rules: [
                {
                  validator(rule, value, cb) {
                    ...
                    if (value && !regMap.moreZero.test(value)) {
...
const getTrainSituationColumns = async () => {
  const { hse_train_exam_status: examStatus } = await getDictMultiple(['hse_train_exam_status'])
  const trainSituationColumns = [
    ...
    },
    {
      ...
      prop: 'examStatus',
      formatter(val) {
        return selectDictLabel(examStatus, val) || '-'
      }
    },
    {
      label: '用时',
...
export { basicInfo, getTrainSituationColumns }
