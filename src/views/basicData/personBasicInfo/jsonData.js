...
const getColumns = async () => {
  const {
    sys_user_sex: sexArr,
    hse_personType: personType,
    sys_yes_no: sysYes
  } = await getDictMultiple(['sys_user_sex', 'hse_personType', 'sys_yes_no'])
  ...
  const columns = [
    ...
    },
    {
      ...
      prop: 'sex',
      formatter(val) {
        return selectDictLabel(sexArr, val) || '-'
      },
      formFormat: {
        type: 'select',
        icon: 'icon-select',
        ...
        options: {
          ...
          showLabel: true,
          width: '100%',
          options: getOptions(sexArr, 'dictLabel', 'dictValue'),
          filterable: false,
          optionDataType: 1,
    ...
    },
    {
      ...
      showOverflowTooltip: true,
      formatter(val) {
        return selectDictLabel(personType, val) || '-'
      },
      width: 130,
      formFormat: {
        type: 'select',
        ...
        options: {
          ...
          showLabel: true,
          width: '100%',
          options: getOptions(personType, 'dictLabel', 'dictValue'),
          filterable: false,
          optionDataType: 1,
          interfaceMethod: '/system/SysDictData/getChildrenItemsByDictType',
          interfaceParam: '{"dictType":"sys_tenant_type"}',
    ...
    },
    {
      ...
      prop: 'isOpenAccount',
      formatter(val) {
        return selectDictLabel(sysYes, val) || '-'
      },
      width: 120,
      formFormat: {
        type: 'select',
        ...
        options: {
          ...
          showLabel: true,
          width: '100%',
          options: getOptions(sysYes, 'dictLabel', 'dictValue'),
          filterable: false,
          optionDataType: 1,
          interfaceMethod: '/system/SysDictData/getChildrenItemsByDictType',
          interfaceParam: '{"dictType":"sys_tenant_type"}',
...
export { getColumns, getAccountDialogFormData }
