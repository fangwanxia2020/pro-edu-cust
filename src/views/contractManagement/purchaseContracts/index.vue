      ...
      <template #rowOperator="{ row }">
        <div>
          <el-button
            ...
            type="text"
            v-show="
              !(row.checkStatus === 1 && row.isConfirm === 1) && row.sourceFromString === '甲方新建'
            "
          ...
          <el-button
            ...
            v-show="row.checkStatus !== 1 && row.sourceFromString === '甲方新建'"
            >删除</el-button
          >
          <el-button
            size="mini"
            ...
            v-show="
              row.checkStatus === 1 &&
              row.sourceFromString.indexOf('新建') !== -1 &&
              row.isConfirm === 0 &&
              row.isShared === 0
            "
            >共享</el-button
          ...
          <el-button
            ...
            type="text"
            v-show="
              (row.checkStatus === 1 && row.isConfirm === 1) || row.sourceFromString === '乙方共享'
            "
          ...
          <el-button
            size="mini"
            type="text"
            v-show="row.sourceFromString === '甲方新建' && row.checkStatus === 1"
            @click="showReactive(row)"
            >乙方反馈详情</el-button
          >
          <el-button
            size="mini"
            v-show="row.sourceFromString === '乙方共享'"
            type="text"
            @click="showReactive(row)"
            >我的反馈详情</el-button
          >
          <el-button
            size="mini"
            v-show="row.sourceFromString === '乙方共享' && row.isConfirm !== 1"
            type="text"
