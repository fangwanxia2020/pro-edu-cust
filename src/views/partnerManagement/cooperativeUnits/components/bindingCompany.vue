...
import { getOrgList, bindCustomerPartner } from '@/api/partnerManagement/cooperativeUnits'
import { getInfoByOrgId } from '@/api/partnerManagement/partner'
...
export default {
  ...
  methods: {
    ...
    getList(relevanceOrgId, isSubmit, supplierId) {
