...
<script>
import { enterpriseTypeTemplateList, customerPartnerInfo } from '@/api/partnerManagement/partner'
...
export default {
  ...
  methods: {
    ...
    getCustomerPartnerInfo() {
      customerPartnerInfo(this.$route.query.customerId).then((res) => {
        if (res.code === 200) {
