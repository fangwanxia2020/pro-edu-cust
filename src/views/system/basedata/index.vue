<template>
  <div class="custom-con">
    <!-- 搜索框内容 -->
    <el-form :inline="true" class="hse-form">
      ...
      <el-form-item>
        ...
        <el-button type="primary" size="small" @click="handleData()">新增</el-button>
      </el-form-item>
    </el-form>
    <div class="searchBox-high-operator-bar" style="padding: 10px !important"></div>
    <!-- 列表展示 -->
    <el-table
      v-loading="loading"
      :data="baseDataLists"
      ...
      default-expand-all
    >
      <el-table-column prop="dataName" label="名称" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="baseIndex" label="代码" width="100"></el-table-column>
      <el-table-column prop="dataType" label="所属分类" width="100"></el-table-column>
      <el-table-column prop="codeType" label="分类编码" width="120"></el-table-column>
      <el-table-column prop="orderNum" label="排序" width="70"></el-table-column>
      <el-table-column prop="baseStatus" label="状态" width="70"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="131px">
        <el-row>
          <el-col :span="12" v-if="form.parentId != 0 && form.baseId != null">
            <el-form-item label="上级数据名称" prop="parentDataName">
              <el-input v-model="form.parentDataName" :disabled="true" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="代码" prop="baseIndex">
              <el-input v-model="form.baseIndex" placeholder="请输入数据代码" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="所属分类" prop="dataType">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="国家标准维护" prop="dataStandard">
              <el-input v-model="form.dataStandard" placeholder="请输入国家标准维护" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="分类编码" prop="codeType">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="排序" prop="orderNum">
              <el-input maxlength="10" v-model="form.orderNum" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="状态" prop="baseStatus">
...
import { getAssembleTree } from '@/utils/tool.js'
  ...
  methods: {
    ...
    selectAllOrg() {
      ...
      listOfBaseDataWithPage(this.queryParams).then((response) => {
        this.baseDataLists = getAssembleTree(response.data.records, 'baseId')
        this.loading = false
