<template>
  <div class="dept-management">
    <el-form class="hse-form" inline ref="queryForm">
      ...
      <el-form-item class="button-group">
        <el-button class="filter-item" type="primary" size="small" @click="handleQuery"
          >搜索</el-button
        >
          ...
          <el-col :span="12">
            <el-form-item label="部门类型" prop="deptType">
              <ty-dictionary
                ...
                action="/basic/system/dict/data/dictType/hse_BMLX"
                resList="data"
              />
            </el-form-item>
          </el-col>
  ...
  methods: {
    ...
    getList() {
      ...
      listDept(this.queryParams).then((response) => {
        this.deptList = getAssembleTree(response.data, 'deptId')
        this.loading = false
      })
    },
    /** 转换部门数据结构 */
    ...
    getTreeselect() {
      listDept().then((response) => {
        this.deptOptions = getAssembleTree(response.data, 'deptId')
      })
    },
    // 字典状态字典翻译
