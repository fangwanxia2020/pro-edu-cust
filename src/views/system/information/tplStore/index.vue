    ...
    <div v-if="columns.length" class="content">
      ...
      >
          ...
          <el-link type="primary">
            <router-link
              :to="{
                ...
                query: { msgId: data.msgId, name: 'tpl' }
              }"
        ...
        <template v-slot:rowOperator="{ data }">
          <el-button type="text" @click="addImMsg(data)">+添加</el-button>
...
<script>
import { addImMsg, removeByIds, pushMsg, getImMsgInfo, editImMsg } from '@/api/system/information'
