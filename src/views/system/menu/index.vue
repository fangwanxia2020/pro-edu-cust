        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="菜单所属类型" prop="menuType">
              <el-radio-group v-model="form.belongType" :disabled="disabledBelongType">
          ...
          <el-col :span="24">
            <el-form-item label="菜单类型" prop="menuType">
              <el-radio-group v-model="form.menuType" :disabled="disabledTenantEdit">
          ...
          <el-col :span="24">
            <el-form-item v-if="form.menuType == 'C'" label="类型">
              <el-radio-group v-model="form.isFrame" :disabled="disabledTenantEdit">
          ...
          <el-col :span="12">
            <el-form-item
              ...
              prop="path"
            >
              <el-input v-model="form.path" placeholder="请输入路由唯一标识" :disabled="disabledTenantEdit" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item
          ...
          <el-col :span="12" v-if="form.menuType == 'C' && form.isFrame == 2">
            <el-form-item label="微应用路径" prop="component">
              <el-input
                v-model="form.component"
  ...
  methods: {
    ...
    getList() {
      ...
      listMenu(this.queryParams).then((response) => {
        this.menuList = getAssembleTree(response.data, "menuId");
        this.loading = false;
      });
    },
    /** 转换菜单数据结构 */
    ...
    getTreeselect() {
      listMenu().then((response) => {
        ...
        menu.children = getAssembleTree(response.data, "menuId");
