      ...
      >
        ...
        >
           <div slot="operator">
            ...
            />
            <templateDown style="margin-right: 10px;" :templateId="25" /> -->
            <el-button
              size="small"
              :disabled="!canDelete"
              @click="delItem"
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.open = true;
      setTimeout(() => {
        console.log('444', this.$refs.postForm)
        this.$refs.postForm.$refs.generateForm.clearValidate();
      }, 1)
    },
    /** 修改按钮操作 */
