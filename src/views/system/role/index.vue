  ...
  <div class="role-management">
    <el-row :gutter="20" class="mb8">
      <el-col :span="24" :xs="24">
        <el-form class="hse-form" ref="queryForm" label-width="100px" inline :model="queryParams">
          ...
          <el-form-item label="角色类型" prop="roleType" v-if="isAdmin">
            <el-select
    ...
    <div class="searchBox-high-operator-bar">
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button type="primary" size="small" @click="handleAdd" v-hasPermi="['system:role:add']"
            >新增</el-button
          >
        </el-col>
        <el-col :span="1.5">
    ...
    >
      ...
      <template v-slot:operation="scope">
        <div v-if="scope.row.roleKey != 'admin'">
          ...
          <el-button size="mini" type="text" @click="handlePermi(scope.row)">权限配置</el-button>
          <!-- <el-button
          size="mini"
          type="text"
        ...
        <div v-else style="color: #ccc">超级管理员角色不允许操作</div>
      </template>
    </ty-table>
    <!-- 添加或修改角色配置对话框 -->
        ...
        <el-form-item label="角色类型" prop="roleType">
          ...
          >
            <el-option
              ...
              :label="dict.label"
              :value="dict.value"
              v-show="(dict.value == 4 && !isTenant) || (dict.value > 1 && dict.value < 3)"
            />
          </el-select>
        </el-form-item>
