<template>
  <div class="role-permi">
    ...
    <div class="button-wrap-fixed">
      <el-button type="primary" @click="updateMenuPermi">修改权限</el-button>
  ...
  methods: {
    ...
    updateMenuPermi() {
      ...
      getRole(roleId).then((response) => {
        ...
        // console.log(menuIdArrays1);
        // console.log(menuIdArrays2);
        // console.log(menuIdArrays3);
        // postForm.menuIds = menuIdArrays1.concat(menuIdArrays2, menuIdArrays3, menuIdArrays4)
        postForm.menuIds = menuIdArrays1
        console.log(postForm.menuIds)
        console.log('啊啊啊啊付多付多发多发')
        // return;
