<template>
  <div style="padding: 20px" class="user-box">
    <el-row :gutter="20">
      <!--部门数据-->
      <el-col :span="4" :xs="24">
        ...
        >
          ...
          <template v-slot:operation="scope">
            ...
            <el-button
              ...
              >删除</el-button
            >
            <el-button size="mini" type="text" @click="handleResetPwd(scope.row)">重置</el-button>
          </template>
        </ty-table>
      </el-col>
    </el-row>
