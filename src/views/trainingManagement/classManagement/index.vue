...
export default {
  ...
  methods: {
    ...
    toStudent(obj) {
      const { schoolClassId } = obj
      this.$router.push({
        path: '/trainingManagement/student',
        query: {
          schoolClassId
        }
      })
    ...
    toTeacher(obj) {
      const { schoolClassId } = obj
      this.$router.push({
        path: '/trainingManagement/teacher',
        query: {
          schoolClassId
        }
      })
    ...
    toContent(obj) {
      const { schoolClassId } = obj
      this.$router.push({
        path: '/trainingManagement/trainingContent',
        query: {
          schoolClassId
        }
      })
    ...
    toOrder(obj) {
      console.log('obj')
      console.log(obj)
      const { schoolClassId, orderNum } = obj
      this.$router.push({
