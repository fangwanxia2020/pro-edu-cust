...
<template>
  <ty-business-crud2
    ...
    @addReport="addReport"
    @editReport="editEnterReport"
    @etpReportDetail="etpReportDetail"
  >
  </ty-business-crud2>
</template>
...
export default {
  ...
  methods: {
    ...
    addReport() {
      this.$router.push({
        path: '/trainingManagement/addReport'
      })
    },
    editEnterReport(id) {
      this.$router.push({
        path: '/trainingManagement/editEnterReport',
        query: {
          evaluateId: id
        }
      })
    ...
    etpReportDetail(id) {
      this.$router.push({
        path: '/trainingManagement/etpReportDetail',
        query: {
          evaluateId: id
        }
      })
